...
//尺寸
#define UIFontSacleSize(size)  [UA_Tools getFontWithFontSize:size]
#define UIFontSize(size)       [UA_Tools getFontWithFontSize:size bold:NO]
#define UIBoldFontSize(size)   [UA_Tools getFontWithFontSize:size bold:YES]
